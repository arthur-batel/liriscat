...
def main(dataset_name, i_fold=None):
    ...
    config = liriscat.utils.generate_eval_config(dataset_name=dataset_name,
                                                 i_fold = i_fold,
                                                 load_params=True, 
                                                 save_params=False, 
                                                 esc = 'error',
                                                 ...
                                                 valid_metric= 'mi_acc', 
                                                 n_query=10,
                                                 num_inner_users_epochs=5, 
                                                 lambda_=9.972254466547545e-06, 
                                                 inner_user_lr=5.723345073386536e-05)
...
def parse_args():
    parser = argparse.ArgumentParser(description="A program that runs the CAT testing session")
