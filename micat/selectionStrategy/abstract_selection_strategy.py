...
from micat.meta_models.meta_models import clone_state_dict, kl_divergence_gaussians, zero_grad
from micat.selectionStrategy.CovWeighting import CoVWeightingLoss
...
class AbstractSelectionStrategy(ABC):
    ...
    def GAP_inner_step(self, users_id, questions_id, labels, categories_id, learning_users_emb=None):
        ...
        #grads_R = (torch.nn.utils.clip_grad_norm_(grads_R[0], max_norm=1000.0),)
    ...
    def GAP_inner_step_one_loss(self, users_id, questions_id, labels, categories_id, learning_users_emb=None):
        ...
        updated_users_emb = learning_users_emb - P1 *grads_L1[0] #- self.config['lambda']*grads_R[0]
    ...
    def MAML_inner_step_one_loss(self, users_id, questions_id, labels, categories_id, learning_users_emb=None):
        ...
        grads = self.clip_tensor_list_by_global_norm(grads,max_norm=500.0)
    ...
    def Approx_GAP_inner_step_one_loss(self, users_id, questions_id, labels, categories_id, learning_users_emb=None):
        ...
        grads_L1 = self.clip_tensor_list_by_global_norm(grads_L1[0],max_norm=50.0)
        grads_R = self.clip_tensor_list_by_global_norm(grads_R[0],max_norm=50.0)
    ...
    def train(self, train_dataset: dataset.CATDataset, valid_dataset: dataset.EvalDataset):
        ...
        match self.config['meta_trainer']:
            ...
            case 'GAP':
                ...
                self.meta_scaler = torch.amp.GradScaler(enabled=str(self.config['device']).startswith('cuda'))
